...
return (
    ...
    >
      <div className="p-4 md:p-12 text-center lg:text-left">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url("https://media-exp1.licdn.com/dms/image/C4E03AQHOItzR09A2uQ/profile-displayphoto-shrink_400_400/0/1633683283035?e=1659571200&v=beta&t=KSM_-Tg9Mf9httFpodGjLVzBJ3FNVBF2Q4rHByAFTsw")'
          }}
        />
        <h1 className="text-3xl font-bold pt-8 lg:pt-0">Sai Adithya</h1>
        ...
        <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
          <a className="link" href="https://www.facebook.com/sai.adithya.1401" data-tippy-content="@facebook_handle">
            <svg
          ...
          <a className="link" href="https://twitter.com/SaiAdithya39" data-tippy-content="@twitter_handle">
            <svg
              className="h-6 fill-current text-gray-600 hover:text-green-700"
              role="img"
              viewBox="0 0 24 24"
          ...
          <a className="link" href="https://github.com/SaiAdithya3" data-tippy-content="@github_handle">
            <svg
              className="h-6 fill-current text-gray-600 hover:text-green-700"
              role="img"
              viewBox="0 0 24 24"
          ...
          <a className="link" href="https://saiadithya3.github.io/portfolio-website/" data-tippy-content="@unsplash_handle">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" className="h-6 fill-current text-gray-600 hover:text-green-700" viewBox="0 0 92 92" >
              <title>Website</title>
	...
	C77.5,69.7,69.6,77.6,59.6,81.5z"/>
          ...
          <a className="link" href="https://www.linkedin.com/in/ksaiadithya/" data-tippy-content="@dribble_handle">
          <svg version="1.1" className="h-6 fill-current text-gray-600 hover:text-green-700" id="Layer_1" 
	 viewBox="0 0 504.4 504.4" >
          ...
          <a className="link" href="https://www.instagram.com/sai_.adithya/" data-tippy-content="@youtube_handle">
            <svg
              className="h-6 fill-current text-gray-600 hover:text-green-700"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
    ...
    <div className="w-full lg:w-2/5">
      ...
      <img
      className='sm'
           src="https://images.unsplash.com/photo-1653537649122-daf08ad1872f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
/>
